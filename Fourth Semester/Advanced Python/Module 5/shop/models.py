...
# from django.contrib.auth.models import User	# Changed to settings.AUTH_USER_MODEL
from django.conf import settings	# New Value for "User"
...
class Design(models.Model):
	...
	created_by = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='design_creator', on_delete=models.CASCADE)
